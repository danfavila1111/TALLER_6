...
<body class="text-center" >
                ...
                <form action="" method="post">
                  ...
                  <div class="form-floating">
                    <input type="text" class="form-control" id="floatingName" placeholder="Porfavor ingrese sus nombres" autofocus required pattern="^[A-Z a-z ]{2,40}$">
                    <label for="floatingName">Nombres:</label>
                  </div>

                  <div class="form-floating">
                    <input type="text" class="form-control" id="floatingLastname" placeholder="Porfavor ingrese sus apellidos" required pattern="^[A-Z a-z ]{2,40}$">
